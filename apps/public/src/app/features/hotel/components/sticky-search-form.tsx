...
function StickySearchForm() {
  ...
  return (
    <div className="container mx-auto px-6 md:px-12">
      <form className="add-form p-2" onSubmit={onSubmit}>
        <div className="md:flex justify-between items-center">
          <div className="">
            <div className="border border-primary-500 flex justify-between rounded text-black md:gap-1.5 bg-white">
          ...
          <div className="">
            <Popover placement="bottom" content={content} trigger="click">
              <div className="border border-primary-500 flex justify-between rounded text-black p-2 gap-2.5 bg-white">
          ...
          <div className="py-1.5">
            <Button
              className="ant-btn ant-btn-lg ant-btn-primary bg-white hover:bg-white hover:text-primary-500 rounded-md text-black w-full"
              type="primary"
              id="submit"
